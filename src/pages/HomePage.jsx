...
const SHIPMENTS = [
  ...
  {
    ref: "LQ-298-X1",
    route: "Matadi → Mbuji-Mayi",
    status: "EXPEDIE",
    date: "17 Avr",
  },
  {
    ref: "LQ-274-C5",
    route: "Kisangani → Bukavu",
    status: "PERDU",
    date: "16 Avr",
  },
  { ref: "LQ-265-A7", route: "Goma → Beni", status: "LIVRE", date: "15 Avr" },
];
...
const STATUS = {
  ...
  LIVRE: { label: "Livré", color: "#16a34a", bg: "rgba(22,163,74,0.1)" },
  EXPEDIE: {
    label: "Expédié",
    color: "#3b82f6",
    bg: "rgba(59,130,246,0.1)",
  },
  ANNULE: { label: "Annulé", color: "#6b7280", bg: "rgba(107,114,128,0.1)" },
  NON_RECUPERE: { label: "Non récupéré", color: "#8b5cf6", bg: "rgba(139,92,246,0.1)" },
  PERDU: { label: "Perdu", color: "#ef4444", bg: "rgba(239,68,68,0.1)" },
};
